...
import type { GitSource, Repo, Url } from "src/types/general";
import type { RepoCommitOptions } from "./types";
import type { ApiWith, RepoApi, RepoCache, RepoConfig, RepoOptions, RepoProvider, ToRepo, ToSource } from "./types/api-types";
import { literal } from "inferred-types";
...
>(repoRep: TRep, options: RepoOptions<TBranch, TReadme, TCommits, TLoadNow> = {} as RepoOptions<TBranch, TReadme, TCommits, TLoadNow>) {
  const env = getEnv();
